...
$string['notificationstype'] = 'Notifications type';
...
$string['eventissueupdated'] = '{$a}\'s record was updated';
$string['eventissuecreated'] = '{$a}\'s record was created';
...
$string['msg_reminder'] = 'It is a reminder message about your {$a->label} <strong>{$a->code}</strong>. View details {$a->url}.';
