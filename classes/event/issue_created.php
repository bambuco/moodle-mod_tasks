...
/**
 * The mod_tasks issue created event.
 *
 * @package mod_tasks
...
/**
 * The mod_tasks issue created event class.
 *
 * @package mod_tasks
 * @copyright  2019 David Herney - cirano
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class issue_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created the issue with id '$this->objectid' in the module with " .
    ...
    public static function get_name() {
        return get_string('eventissuecreated', 'mod_tasks');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'tasks', 'add issue', $logurl, $this->objectid, $this->contextinstanceid);
    }
