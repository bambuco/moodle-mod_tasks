...
/**
 * Defines backup_tasks_activity_task class
 *
 * @package mod_tasks
...
require_once($CFG->dirroot . '/mod/tasks/backup/moodle2/backup_tasks_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the Page instance
 */
class backup_tasks_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the tasks.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_tasks_activity_structure_step('tasks_structure', 'tasks.xml'));
    }
